            ...
            <form className="postForm">
                ...
                <fieldset>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            autoFocus
                            type="text"
                            className="form-control input postTitleInput"
                            placeholder="Got a fun title? Add it here!"
                            value={post.title}
                            onChange={(evt) => {
                                const copy = { ...post };
                ...
                <fieldset>
                    <div className="form-group">
                        ...
                        <select
                            ...
                            className="form-control select categorySelect"
                        >
                ...
                <fieldset>
                    ...
                    <section className="py-2 px-4">
                        {tagList.length > 0 &&
                            tagList.map((tag) => (
                                <div key={`tagCheck--${tag.id}`} className="tagCheckbox">
                ...
                <fieldset>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            autoFocus
                            type="text"
                            className="form-control input newTagInput"
                        ...
                        <button
                            ...
                            className="btn btn-secondary createTagButton"
                        >
                            Create Tag
                        </button>
                    </div>
